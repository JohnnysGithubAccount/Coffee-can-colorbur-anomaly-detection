...
def run(
    ...
    for dataloader_count, dataloaders in enumerate(list_of_dataloaders):
        print("Cleared Memory:", gc.collect())
        # Clear memory cache to prevent memory leaking
        ...
        # specify seed for result reproduction
...
@click.option("--backbone_names", "-b", type=str, multiple=True, default=["wideresnet"])
